...
bool ColorShaderClass::Initialize(ID3D10Device* device, HWND hwnd) {
	...
	// Initialize the shaders that will be used for rendering.
...
bool ColorShaderClass::Render(ID3D10Device* device, int indexCount, XMMATRIX& worldMatrix, XMMATRIX& viewMatrix, XMMATRIX& projectionMatrix) {
	bool result;
...
bool ColorShaderClass::SetShaderParameters(ID3D10Device* device, XMMATRIX& worldMatrix, XMMATRIX& viewMatrix, XMMATRIX& projectionMatrix) {
	HRESULT result;
	void* mappedResource;
